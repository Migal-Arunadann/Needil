...
Future<void> main() async {
  ...
  try {
    ...
    final token = await _adminAuth(client, 'arun@arun.com', 'arunarun');
    print('✅ Authenticated\n');
    ...
    _addIfMissing(aFields, {'name': 'patient_details_filled_time', 'type': 'date', 'required': false});
    _addIfMissing(aFields, {'name': 'consultation_start_time', 'type': 'date', 'required': false});
