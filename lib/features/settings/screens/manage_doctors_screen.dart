...
class _ManageDoctorsScreenState extends ConsumerState<ManageDoctorsScreen> {
  ...
  Widget _avatar(String? photoUrl, {required bool isPrimary}) => Container(
    ...
    decoration: BoxDecoration(
      ...
      image: photoUrl != null ? DecorationImage(image: NetworkImage(photoUrl, headers: ImageHelper.getAuthHeaders(photoUrl, ref.read(pocketbaseProvider).authStore.token)), fit: BoxFit.cover) : null,
    ),
    child: photoUrl == null
