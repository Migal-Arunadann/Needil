                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: isClinic
                                  ? (!kIsWeb && _logoFile != null ? FileImage(_logoFile!) : (_existingLogoUrl != null ? NetworkImage(ImageHelper.getSecureUrl(_existingLogoUrl!, ref.read(pocketbaseProvider).authStore.token)) as ImageProvider : null))
                                  : (!kIsWeb && _photoFile != null ? FileImage(_photoFile!) : (_existingPhotoUrl != null ? NetworkImage(ImageHelper.getSecureUrl(_existingPhotoUrl!, ref.read(pocketbaseProvider).authStore.token)) as ImageProvider : null)),
